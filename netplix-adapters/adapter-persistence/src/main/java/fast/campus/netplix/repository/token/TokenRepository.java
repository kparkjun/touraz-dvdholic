...
public class TokenRepository implements SearchTokenPort, InsertTokenPort, UpdateTokenPort, DeleteTokenPort {
    ...
    @Override
    @Transactional
    public void deleteByTokenUserId(String tokenUserId) {
        tokenJpaRepository.deleteByUserId(tokenUserId);
    }
}
