        ...
        >
          ...
          <div className="relative z-10">
            ...
            {oauthError && (
              ...
              >
                <p style={{ color: '#fca5a5', fontSize: '13px', textAlign: 'center', marginBottom: '8px' }}>
                  {t("login.oauthFailed")}
                </p>
                <p style={{ color: 'rgba(252, 165, 165, 0.9)', fontSize: '12px', textAlign: 'center', marginBottom: '12px', lineHeight: 1.5 }}>
                  {t("login.oauthRetry")}
                </p>
